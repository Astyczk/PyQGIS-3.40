...
### 为什么这样改更好？
1. **增加了 Quick Start**：这是 GitHub 仓库的灵魂。别人（或者未来的你）第一眼看的就是怎么运行起来。
2. **路径适配更清晰**：强调了“代码无需改动，只需改 .bat”，这体现了你代码的**健壮性**。
3. **强调了 Qt6**：因为 QGIS 的这个版本跨越很大，明确 Qt6 能避免很多拿着旧教程对比产生的疑惑。
